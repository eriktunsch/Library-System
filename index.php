               ...
               <div class="row row-cols-3">
                  ...
                  <div class="col-lg-4 col-md-6">
                     <div class="card card-dark">
                        <img src="data:image/png;base64,<?php echo $thumbnail; ?>" class="bd-placeholder-img card-img-top" style="width: 25%; margin: 0 auto">
                        <div class="card-body">
                           <h5 class="card-title"><?php echo $obj->title; ?></h5>
                           <h6 class="card-title"><i><?php echo $obj->subtitle; ?></i></h6>
                           <p class="card-text"><?php 
                           $string = strip_tags($obj->description);
                           if (strlen($obj->description) > 250) {
                           
                               // truncate string
                               $stringCut = substr($obj->description, 0, 250);
            ...
            <div class="card-body">
               <div class="d-flex justify-content-between align-items-center">
                  ...
                  <div class="text-end">
                     ...
                     <h3 class="counter"><?php echo $db->query('SELECT id FROM rents WHERE `user`="' . $User->getId() . '" AND returned IS NULL')->num_rows; ?></h3>
                  </div>
               </div>
            </div>
         </div>
