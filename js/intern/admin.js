...
function loadChanger(isbn) {
  RestRequest(
    ...
    function (response) {
      ...
      tagElements["authors_i_change"].addTags(
      ...
      pond_change = FilePond.create(
        document.getElementById("thumbnail_change"),
        {
          acceptedFileTypes: ["image/*"],
          imagePreviewHeight: 256,
          fileValidateTypeDetectType: (source, type) =>
    ...
    if (e.keyCode === 13) {
      ...
      if (code.length > 10) {
        RestRequest(
          ...
          function (data) {
            document.getElementById("selectBookContent").innerHTML =
              b64DecodeUnicode(data.data.html);
