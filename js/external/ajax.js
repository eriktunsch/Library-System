    ...
    if (!($.Ajaxy || false)) {
        ...
        $.Ajaxy = {
            ...
            options: {
                ...
                scrollto_options: {
                    duration: 800,
                    /* Set to 0 to have no scroll animation effect */
                ...
                var Request = {
                    ...
                    success: function(responseData, status) {
                        ...
                        if (controller === null) {
                            ...
                            // Issue warning
                            window.console.warn(
                                'Ajaxy.request.success.controller: The controller was unable to be determined, defaulted to _generic.', [this, arguments], [responseData.controller, State.controller]
                            );
                        }
                    ...
                    error: function(XMLHttpRequest, textStatus, errorThrown, responseData) {
                        ...
                        if (controller === null) {
                            ...
                            // Issue warning
                            window.console.warn(
                                'Ajaxy.request.error.controller: The controller was unable to be determined, defaulted to _generic.', [this, arguments], [responseData.controller, State.controller]
                            );
                        }
                    ...
                    if (typeof responseText !== 'object' && Ajaxy.options.support_text && responseText) {
                        ...
                        // Invalid JSON
                            ...
                            var html = Ajaxy.htmlCompat(responseText),
                                ...
                                /* special case support for controller in html pages */
            ...
            ajaxifyHelpers: {
                ...
                form: function(event) {
                    ...
                    // Check
                    var disabled = $form.attr('disabled');
